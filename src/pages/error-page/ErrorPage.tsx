...
export const ErrorPage: FC<ErrorPageProps> = ({paragraph}: ErrorPageProps) => {
    return (
        <div className={`${classes.errorPage__wrapper} cc-main-gutter cc-grid cc-gap-9 cc-pt-13 cc-laptop-pt-15`}>
